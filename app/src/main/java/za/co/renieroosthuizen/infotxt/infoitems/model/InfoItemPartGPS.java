 ...
 */
public class InfoItemPartGPS extends InfoItemPart {

    public InfoItemPartGPS(String guid, String name, List<InfoItemPartParameter> parameters)
    {
        this.setType(InfoItemType.GPS);
        this.setGuid(guid);
        this.setName(name);

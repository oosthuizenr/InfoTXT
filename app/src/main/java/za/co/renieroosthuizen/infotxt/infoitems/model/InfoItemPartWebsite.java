 ...
 */
public class InfoItemPartWebsite extends InfoItemPart {

    public InfoItemPartWebsite(String guid, String name, List<InfoItemPartParameter> parameters)
    {
        this.setType(InfoItemType.Website);
        this.setGuid(guid);
        this.setName(name);
